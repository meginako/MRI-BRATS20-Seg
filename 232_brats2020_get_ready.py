...
TRAIN_DATASET_PATH = 'G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/'
# VALIDATION_DATASET_PATH = 'BraTS2020_ValidationData/MICCAI_BraTS2020_ValidationData'
#e ka gabim ate 355 dhe prit ne rregull esthe mungon ajo segment
...
test_mask = nib.load(TRAIN_DATASET_PATH + 'BraTS20_Training_354/BraTS20_Training_354_seg.nii').get_fdata()#e provojm po kam frik se mos ehste file i gabuar nshif pak ca thot ktu e le,e njehere ska gje mir eshte
#po qe kodi me duket njellojh me ate tjetrin e provojm njer
...
imsave('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/combined255.tif', combined_x)
np.save('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/combined255.npy', combined_x)
# Verify image is being read properly
# my_img=imread('BraTS2020_TrainingData/combined255.tif')

my_img = np.load('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/combined255.npy')
...
t2_list = sorted(glob.glob('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*t2.nii'))
t1ce_list = sorted(glob.glob('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*t1ce.nii'))
flair_list = sorted(glob.glob('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*flair.nii'))
mask_list = sorted(glob.glob('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/MICCAI_BraTS2020_TrainingData/*/*seg.nii'))
...
for img in range(len(t2_list)):  # Using t1_list as all lists are of same size
    ...
    if (1 - (counts[0] / counts.sum())) > 0.01:  # At least 1% useful volume with labels that are not 0
        ...
        np.save('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/input_data_3channels/images/image_' + str(img) + '.npy', temp_combined_images)
        np.save('G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/input_data_3channels/masks/mask_' + str(img) + '.npy', temp_mask)
...
input_folder = 'G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/input_data_3channels/'
output_folder = 'G:/Alban & Megi/BrainSegmentation/dataset/BraTS2020_TrainingData/input_data_128/'
# Split with a ratio.
